...
public class ClassDefinitionBuilder {
	...
	private List iPackages = new ArrayList();
	 ...
	 */
	public ClassDefinitionBuilder(String inputFile) throws ClassNotFoundException, LicenseNotFoundException, ProjectNotFoundException, NonCompatibleException, IOException, ProjectLockedException {
		...
		// get all packages of the project.
				iPackages = getAllPackages(iModel);
	 ...
	 * @throws NonCompatibleException
	 *             Old Model Version (The version of API is older than the
	 *             version of Astah that the project has been last edited with)
	 * @throws ClassNotFoundException
	 ...
	 */
	public List getContents() throws LicenseNotFoundException, ProjectNotFoundException, NonCompatibleException,
	 ...
	 * @return Class information (String List stored in the list)
	 */
	public List getClassInfos(IPackage iPackage) {
	...
	private String getImplementation(IClass iClass) {
		...
		for (int i = 0; i < realizations.length; i++) {
			INamedElement realization = realizations[i].getSupplier();
			if (realization instanceof IClass) {
				buffer.append(getFullName((IClass) realization));
	...
	public List getIpackage(){
		return this.iPackages;
	}
}
